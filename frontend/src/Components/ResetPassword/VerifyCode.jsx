      ...
      <div className='container' stlye={{height:'80%'}}>
        {
          ...
          <AlertTitle><strong>Request Invalid.</strong></AlertTitle>
          {alertMessage}
        </Alert>
        }
        ...
        <div className="submit-container">
          <div className="submit" onClick={() => navigate('/loginSignUp')}>Cancel</div>
          <div className="submit" onClick={() => handleResetRequest(email)}>Submit Request</div>
        </div>
      </div>
    </div>
  );
